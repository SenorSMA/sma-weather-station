...
#define USEREMOTEDEBUG 0 // customize, use remote debug (weatherbase)
...
#define USE_WIND_AS5600 1 // customize, enable code for anemometer and wind vane using reed/AS5600
...
#define USE_BATTERY 1 // customize, enable code for battery level
...
#define LATITUDE (20.0+54.917/60.0)   // San Miguel de Allende
#define LONGITUDE -(100.0+44.633/60.0) // Negative for West
